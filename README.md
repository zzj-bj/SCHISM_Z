...
Three available options :
   - Auto brightness/contrast adjustment: Automatically adjust the brightness and contrast of your images. This process rescales pixel values based on histogram minimum/maximum (hmin/hmax). You can choose a reference image to compute the hmin/hmax or compute them individually for each image. The original `images` folder will be renamed to `raw_images`, and the new adjusted images will be saved in a newly created `images` folder. The function has been inspired by the work of [Schindelin et al. 2012](https://www.nature.com/articles/nmeth.2019) / [Fiji](https://github.com/fiji) 
